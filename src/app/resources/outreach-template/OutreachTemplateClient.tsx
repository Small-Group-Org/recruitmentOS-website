    ...
    return (
        <section className="min-h-screen bg-[#F9FAFB]">
            ...
            <div className="max-w-2xl mx-auto px-4 py-10 sm:py-14">
                ...
                {/* Hero */}
                <div className="mb-8">
                    <div className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-full bg-[#FFF4EB] border border-[#FFD9B8] text-[#FF6A00] mb-4">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#FF6A00] animate-pulse" />
                        Free Access
                    </div>
