...
export const services: Service[] = [
    ...
    },
    {
        ...
        deepDive: 'Niche-aware copy, trigger-specific openers, 4-touch cadences. Built on your Smartlead, your domains, your inboxes. We operate it daily. You own everything.',
    ...
    },
    {
        ...
        oneLine: 'We answer the noise so your recruiters only see "yes".',
        deepDive: '6-bucket classification. Only positive-intent goes to recruiters within 4 business hours. Everything else gets routed to nurture, LinkedIn, or suppression.',
