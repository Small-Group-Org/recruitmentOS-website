export default function EmailMockup() {
    return (
        <section className="py-16 md:py-24 bg-white" id="email-example">
            <div className="max-w-[1280px] mx-auto px-5">
                <div className="text-center mb-12 sm:mb-20">
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-[48px] font-black mb-4 sm:mb-6 text-[#1F2937] tracking-tight leading-tight">
                        The Email Your Competitors<br className="hidden sm:inline" /> Can&apos;t Send
                    </h2>
                    <p className="text-lg sm:text-xl text-[#4B5563] max-w-[620px] mx-auto font-medium leading-relaxed">
                ...
                <div className="max-w-[700px] mx-auto">
                    <div className="bg-white border-2 border-[#1F2937] rounded-[2rem] overflow-hidden btn-shadow">

                        {/* Browser / Mail topbar */}
                        <div className="bg-[#F9FAFB] border-b-2 border-[#1F2937] px-5 py-3 flex items-center gap-2">
                            <div className="w-3 h-3 rounded-full bg-[#FF5F56]"></div>
                            <div className="w-3 h-3 rounded-full bg-[#FFBD2E]"></div>
                            <div className="w-3 h-3 rounded-full bg-[#27C93F]"></div>
                            <div className="ml-4 text-xs text-[#9CA3AF] font-bold uppercase tracking-widest">Inbox — Gmail</div>
                        </div>
                        ...
                        <div className="px-6 sm:px-10 pt-8 pb-2">
                            <div className="flex gap-3 text-sm border-b border-slate-100 pb-3 mb-3">
                                ...
                                <span className="text-[#1F2937] font-semibold">Sarah @ RecruitmentOS Agency &lt;sarah@agencyname.com&gt;</span>
                            </div>
                            <div className="flex gap-3 text-sm border-b border-slate-100 pb-3 mb-3">
                                <span className="text-slate-400 font-bold w-14 shrink-0">TO</span>
                                <span className="text-[#4B5563]">thomas.m@techcompany.de</span>
                            </div>
                            <div className="flex gap-3 text-sm pb-6 mt-2">
                                <span className="text-slate-400 font-bold w-14 shrink-0">RE</span>
                                <span className="text-[#1F2937] font-black text-base">Already have your Senior Python Engineer</span>
                            </div>
                        </div>

                        {/* Email body */}
                        <div className="px-6 sm:px-10 pb-10 text-[#4B5563] text-sm sm:text-base leading-relaxed font-medium space-y-4">
                            <p>
                            ...
                            <p className="text-[#9CA3AF]">— Sarah</p>
                    ...
                    <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                        {[
                            ...
                            <div key={i} className="bg-[#F9FAFB] border-2 border-[#1F2937] rounded-2xl p-4 sm:p-6 btn-shadow">
                                <div className="text-lg sm:text-2xl font-black text-[#1F2937] tracking-tight">{item.value}</div>
                                <div className="text-[10px] sm:text-xs text-[#4B5563] font-bold uppercase tracking-widest mt-1">{item.label}</div>
                                <div className="text-[10px] sm:text-xs text-[#9CA3AF] font-medium mt-0.5">{item.sub}</div>
                            </div>
                        ))}
                    </div>
                </div>
