  ...
  return (
    <div className="relative w-full max-w-[640px] mx-auto lg:ml-auto">
      ...
      <div
        ...
        style={{ boxShadow: '0 15px 35px -5px rgba(0,0,0,0.08), 0 5px 15px -5px rgba(0,0,0,0.04)' }}
      >
        <div className="flex -space-x-2 shrink-0">
          ...
          <div className="w-8 h-8 rounded-full border-2 border-white bg-neutral-100 flex items-center justify-center text-[10px] font-bold text-neutral-600">+34</div>
        </div>
        <div>
          ...
          <div className="flex items-center justify-between mt-2">
            <p className="text-[10px] text-neutral-500 font-medium">UK, US and Germany Based Recruitment Agencies</p>
            <div className="flex gap-0.5 text-[#FF6B00] ml-2">
              {[1,2,3,4,5].map(i => (
